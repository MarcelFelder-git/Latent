...
export interface FilmStock {
  ...
  halation: {
    /** Ab welcher Luminanz Licht in die Nachbarschaft streut. */
    threshold: number;
  ...
  /**
   * Der Scanner ist Teil des Looks, nicht neutral. Frontier und Noritsu
   * liefern sichtbar verschiedene Ergebnisse - hier steckt vorerst ein Profil
   * pro Stock drin, spaeter wird das ein eigener Umschalter.
   */
  scanner: {
    /** Anhebung der Schwarzwerte pro Kanal (Grundschleier des Traegers). */
...
export const STOCKS: FilmStock[] = [
  {
    ...
    halation: { threshold: 0.6, radius: 1.4, strength: 0.55, tint: [1.0, 0.34, 0.16] },
    scanner: { lift: [0.014, 0.012, 0.018], gain: [0.985, 0.99, 0.98] },
  },
  {
    slug: "cinestill-800t",
    name: "Cinestill 800T",
    ...
    halation: { threshold: 0.5, radius: 2.6, strength: 1.15, tint: [1.0, 0.16, 0.08] },
    scanner: { lift: [0.02, 0.016, 0.026], gain: [0.98, 0.985, 0.975] },
  },
];
